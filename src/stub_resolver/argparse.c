...
const char* argp_program_version = "not-dig 0.0.1";
const char* argp_program_bug_address = "<not-dig@frazao.ca>";
static char doc[] = "not-dig -- A minimal clone of BIND's dig tool";
